...
//            case WEATHER_WITH_LOCATION:
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = getAllWeather(uri, projection, selection, selectionArgs, sortOrder);
                break;
            }
            // "location"
            case LOCATION: {
                retCursor = getLocations(uri, projection, selection, selectionArgs, sortOrder);
                break;
            }
