...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (((cur != null) && (cur.getCount() > 0))) {
            if (cur.moveToFirst()) {
                locationId = cur.getLong(cur.getColumnIndex(WeatherContract.LocationEntry._ID));
            } else {
                throw new SQLException("Unknown error in reading cursor");
            }
        } else {
        ...
        try {
            ...
            if ( cur.moveToFirst() ) {
                do {
                    ...
                    cVVector.add(cv);
                    Log.d(LOG_TAG, "FetchWeatherTask:" + cv);
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Log.d(LOG_TAG, "Connection string: " + url.toString());
